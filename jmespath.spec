...
Source0  : https://files.pythonhosted.org/packages/2c/30/f0162d3d83e398c7a3b70c91eef61d409dea205fb4dc2b47d335f429de32/jmespath-0.9.4.tar.gz
...
%prep
%setup -q -n jmespath-0.9.4
cd %{_builddir}/jmespath-0.9.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583161278
...
cp %{_builddir}/jmespath-0.9.4/LICENSE.txt %{buildroot}/usr/share/package-licenses/jmespath/c012ed6967c9b5f4a93271c9b3132bcbd76320e0
